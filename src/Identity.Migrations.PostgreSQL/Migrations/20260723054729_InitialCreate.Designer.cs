...
[Migration("20260723054729_InitialCreate")]
partial class _20260723054729_InitialCreate
{
    /// <inheritdoc />
...
#pragma warning disable 612, 618
        ...
        modelBuilder.Entity("Norse.Identity.NorseOpenIddictApplication", b =>
            {
                b.Property<Guid>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("uuid")
        ...
        modelBuilder.Entity("Norse.Identity.NorseOpenIddictAuthorization", b =>
            {
                b.Property<Guid>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("uuid")
        ...
        modelBuilder.Entity("Norse.Identity.NorseOpenIddictScope", b =>
            {
                b.Property<Guid>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("uuid")
        ...
        modelBuilder.Entity("Norse.Identity.NorseOpenIddictToken", b =>
            {
                b.Property<Guid>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("uuid")
        ...
        modelBuilder.Entity("Norse.Identity.NorseRole", b =>
            {
                b.Property<Guid>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("uuid")
        ...
        modelBuilder.Entity("Norse.Identity.NorseRoleClaim", b =>
            {
        ...
        modelBuilder.Entity("Norse.Identity.NorseUser", b =>
            {
                b.Property<Guid>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("uuid")
        ...
        modelBuilder.Entity("Norse.Identity.NorseUserClaim", b =>
            {
                var id = b.Property<int>("Id")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("integer")
        ...
        modelBuilder.Entity("Norse.Identity.NorseUserLogin", b =>
            {
        ...
        modelBuilder.Entity("Norse.Identity.NorseUserPasskey", b =>
            {
        ...
        modelBuilder.Entity("Norse.Identity.NorseUserRole", b =>
            {
                b.Property<Guid>("UserId")
                    .HasColumnType("uuid")
                    .HasColumnName("user_id");
        ...
        modelBuilder.Entity("Norse.Identity.NorseUserToken", b =>
            {
                b.Property<Guid>("UserId")
                    .HasColumnType("uuid")
                    .HasColumnName("user_id");
        ...
        modelBuilder.Entity("Norse.Identity.NorseOpenIddictAuthorization", b =>
            {
                b.HasOne("Norse.Identity.NorseOpenIddictApplication", "Application")
        ...
        modelBuilder.Entity("Norse.Identity.NorseOpenIddictToken", b =>
            {
                ...
                b.HasOne("Norse.Identity.NorseOpenIddictAuthorization", "Authorization")
                    .WithMany("Tokens")
        ...
        modelBuilder.Entity("Norse.Identity.NorseRoleClaim", b =>
            {
                b.HasOne("Norse.Identity.NorseRole", "Role")
                    .WithMany("Claims")
        ...
        modelBuilder.Entity("Norse.Identity.NorseUserClaim", b =>
            {
                b.HasOne("Norse.Identity.NorseUser", "User")
                    .WithMany("Claims")
        ...
        modelBuilder.Entity("Norse.Identity.NorseUserPasskey", b =>
            {
                ...
                b.OwnsOne("Microsoft.AspNetCore.Identity.IdentityPasskeyData", "Data", b1 =>
                    {
                        b1.Property<byte[]>("NorseUserPasskeyCredentialId");
                        ...
                        b1.HasKey("NorseUserPasskeyCredentialId");
                        ...
                        b1.WithOwner()
                            .HasForeignKey("NorseUserPasskeyCredentialId");
                    });
