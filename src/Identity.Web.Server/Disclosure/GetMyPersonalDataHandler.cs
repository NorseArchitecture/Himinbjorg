...
///     not hardcoded to <see cref="ClaimTypes.NameIdentifier" /> -- this is the
...
/// </remarks>
sealed class GetMyPersonalDataHandler(
	NorseIdentityDbContext context,
	IPrincipalAccessor principalAccessor,
	IOptions<IdentityOptions> options) :
	IRequestHandler<GetMyPersonalDataCommand, PersonalDataResponse>
{
	/// <inheritdoc />
	public async ValueTask<Outcome<PersonalDataResponse>> Handle(GetMyPersonalDataCommand request,
